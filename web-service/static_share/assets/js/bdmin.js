...
!function() {
    ...
    onText: data_on_label, offText:data_off_label;
}
);
});
...
, 550);
    ...
    $navbar.hasClass("bg-white")&&500<$(window).width()?$navbar.removeClass("bg-white").addClass("navbar-transparent"): $navbar.hasClass("navbar-transparent")&&$(window).width()<500&&"false"!=a&&$navbar.addClass("bg-white").removeClass("navbar-transparent");
}
}), blackDashboard= {
    misc:  {
